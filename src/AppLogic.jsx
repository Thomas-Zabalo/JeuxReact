export default class AppLogic {
    ...
    createStartButton() {
        // Vérifiez si un bouton existe déjà pour éviter les doublons
        ...
        // Ajouter l'événement de clic pour démarrer le jeu
        startButton.addEventListener("click", () => {
            this.startGame();
            startButton.remove(); // Supprime le bouton après démarrage
        });
    }
    ...
    startGame() {
        ...
        // Supprime le bouton s'il existe encore
        const startButton = document.querySelector("button");
        if (startButton) startButton.remove();

        if (!this.isMobile) {
            // Lecture de la musique de fond pour desktop
