...
const MoneyContext = createContext({
    ...
    food: 0,
    goldIngot: 0,
    addGoldIngot: (amount) => { void(amount); },
    removeGoldIngot: (amount) => { void(amount); },
    addCoin: (amount) => { void(amount); },
    removeCoin: (amount) => { void(amount); },
    addCrystals: (amount) => { void(amount); },
    removeCrystals: (amount) => { void(amount); },
    addFood: (amount) => { void(amount); },
    removeFood: (amount) => { void(amount); }
});
